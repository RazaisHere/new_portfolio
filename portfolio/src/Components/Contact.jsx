...
function Contact() {
  return (
    <section id='contact' className='section'>
        ...
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col ">
            ...
            <div className="flex items-center gap-2 mt-auto">
                {socialLinks.map(({href,icon},index)=>(
                    <a href={href} target='_blank' className="w-12 h-12 grid place-items-center ring-inset ring-2  ring-zinc-50/5 rounded-lg transition-[background-color,color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80" key={index}>
                        {icon}
                    </a>
                ))}
            </div>
        ...
        <form action="https://api.web3forms.com/submit" method='POST' className='xl:pl-102xl:pl-20' >
        <input type="hidden" name="access_key" value={"e8f18410-ea3c-4e3e-8175-b1edaecdd7b8"} />
            <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                <div className="mb-4">
                    <label htmlFor="name" className='label reveal-up'>
                        Name
                    </label>
                    <input type="text" name="name" id='name' className='text-field  reveal-up' autoComplete='name' required placeholder='Ali Raza' />
                </div>
                ...
                <div className="mb-4">
                    ...
                    <input type="email" name="email" id='email' className='text-field  reveal-up' autoComplete='email' required placeholder='info@example.com' />
                </div>
            </div>
